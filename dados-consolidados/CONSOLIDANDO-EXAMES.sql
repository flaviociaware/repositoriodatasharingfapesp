...
-- CRIANDO INTEGRIDADE REFERENCIAL ENTRE EXAMES E PACIENTES
ALTER TABLE EXAMES ADD CONSTRAINT FK_PACIENTE_EXAMES FOREIGN KEY (ID_PACIENTE) REFERENCES PACIENTES(ID_PACIENTE);
